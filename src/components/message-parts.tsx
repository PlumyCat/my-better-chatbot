...
// Utility functions for file references
const FILE_REFERENCE_PATTERN = /^\[File: (.+)\] \(ID: (.+)\)$/;

const isFileReference = (text: string): boolean => {
    ...
    return (
      <div className="flex flex-col gap-2 items-end my-2">
        <div
          ...
          className={cn(
            "flex flex-col gap-4 max-w-full ring ring-input relative overflow-hidden bg-accent text-accent-foreground px-4 py-3 rounded-2xl",
            {
              "opacity-50": isError,
            },
